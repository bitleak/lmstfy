...
func (x *ExtendedJob) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ExtendedJob) ProtoMessage() {}

func (x *ExtendedJob) ProtoReflect() protoreflect.Message {
	mi := &file_engine_redis_v2_model_job_proto_msgTypes[0]
...
// Deprecated: Use ExtendedJob.ProtoReflect.Descriptor instead.
func (*ExtendedJob) Descriptor() ([]byte, []int) {
	return file_engine_redis_v2_model_job_proto_rawDescGZIP(), []int{0}
}

func (x *ExtendedJob) GetBody() []byte {
	if x != nil {
		return x.Body
	}
	return nil
...
func (x *ExtendedJob) GetAttributes() map[string]string {
	if x != nil {
		return x.Attributes
	}
	return nil
...
var file_engine_redis_v2_model_job_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x05, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x22, 0xa4, 0x01, 0x0a, 0x0b, 0x45, 0x78, 0x74,
	0x65, 0x6e, 0x64, 0x65, 0x64, 0x4a, 0x6f, 0x62, 0x12, 0x12, 0x0a, 0x04, 0x62, 0x6f, 0x64, 0x79,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x62, 0x6f, 0x64, 0x79, 0x12, 0x42, 0x0a, 0x0a,
	0x61, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x22, 0x2e, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x2e, 0x45, 0x78, 0x74, 0x65, 0x6e, 0x64, 0x65,
	0x64, 0x4a, 0x6f, 0x62, 0x2e, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x73, 0x45,
	...
	0x29, 0x5a, 0x27, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6c, 0x6d,
	0x73, 0x74, 0x66, 0x79, 0x2f, 0x65, 0x6e, 0x67, 0x69, 0x6e, 0x65, 0x2f, 0x72, 0x65, 0x64, 0x69,
	0x73, 0x5f, 0x76, 0x32, 0x2f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_engine_redis_v2_model_job_proto_goTypes = []interface{}{
	(*ExtendedJob)(nil), // 0: model.ExtendedJob
	nil,                 // 1: model.ExtendedJob.AttributesEntry
}
var file_engine_redis_v2_model_job_proto_depIdxs = []int32{
	1, // 0: model.ExtendedJob.attributes:type_name -> model.ExtendedJob.AttributesEntry
